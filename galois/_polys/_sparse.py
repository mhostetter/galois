...
def neg(a_degrees: np.ndarray, a_coeffs: Array) -> Tuple[np.ndarray, Array]:
    """
    c(x) = -a(x)
    a(x) + -a(x) = 0
    """
...
def sub(a_degrees: np.ndarray, a_coeffs: Array, b_degrees: np.ndarray, b_coeffs: Array) -> Tuple[np.ndarray, Array]:
    """
    c(x) = a(x) - b(x)
    """
    field = type(a_coeffs)
...
def mul(a_degrees: np.ndarray, a_coeffs: Array, b_degrees: np.ndarray, b_coeffs: Array) -> Tuple[np.ndarray, Array]:
    """
    c(x) = a(x) * b(x)
    c(x) = a(x) * b = a(x) + ... + a(x)
    """
