...
def test_repr_table():
    GF = galois.GF(2**3)
    assert GF.repr_table() == " Power    Polynomial     Vector    Integer \n------- ------------- ----------- ---------\n   0          0        [0, 0, 0]      0     \n  x^0         1        [0, 0, 1]      1     \n  x^1         x        [0, 1, 0]      2     \n  x^2        x^2       [1, 0, 0]      4     \n  x^3       x + 1      [0, 1, 1]      3     \n  x^4      x^2 + x     [1, 1, 0]      6     \n  x^5    x^2 + x + 1   [1, 1, 1]      7     \n  x^6      x^2 + 1     [1, 0, 1]      5     "
    assert GF.repr_table(sort="int") == " Power    Polynomial     Vector    Integer \n------- ------------- ----------- ---------\n   0          0        [0, 0, 0]      0     \n  x^0         1        [0, 0, 1]      1     \n  x^1         x        [0, 1, 0]      2     \n  x^3       x + 1      [0, 1, 1]      3     \n  x^2        x^2       [1, 0, 0]      4     \n  x^6      x^2 + 1     [1, 0, 1]      5     \n  x^4      x^2 + x     [1, 1, 0]      6     \n  x^5    x^2 + x + 1   [1, 1, 1]      7     "

    alpha = GF.primitive_elements[-1]
    assert GF.repr_table(alpha) == "      Power         Polynomial     Vector    Integer \n----------------- ------------- ----------- ---------\n        0               0        [0, 0, 0]      0     \n (x^2 + x + 1)^0        1        [0, 0, 1]      1     \n (x^2 + x + 1)^1   x^2 + x + 1   [1, 1, 1]      7     \n (x^2 + x + 1)^2      x + 1      [0, 1, 1]      3     \n (x^2 + x + 1)^3        x        [0, 1, 0]      2     \n (x^2 + x + 1)^4     x^2 + 1     [1, 0, 1]      5     \n (x^2 + x + 1)^5     x^2 + x     [1, 1, 0]      6     \n (x^2 + x + 1)^6       x^2       [1, 0, 0]      4     "
    assert GF.repr_table(alpha, sort="int") == "      Power         Polynomial     Vector    Integer \n----------------- ------------- ----------- ---------\n        0               0        [0, 0, 0]      0     \n (x^2 + x + 1)^0        1        [0, 0, 1]      1     \n (x^2 + x + 1)^3        x        [0, 1, 0]      2     \n (x^2 + x + 1)^2      x + 1      [0, 1, 1]      3     \n (x^2 + x + 1)^6       x^2       [1, 0, 0]      4     \n (x^2 + x + 1)^4     x^2 + 1     [1, 0, 1]      5     \n (x^2 + x + 1)^5     x^2 + x     [1, 1, 0]      6     \n (x^2 + x + 1)^1   x^2 + x + 1   [1, 1, 1]      7     "
