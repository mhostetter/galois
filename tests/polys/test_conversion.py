...
def test_integer_to_poly():
    ...
    assert galois.field.poly_conversion.integer_to_poly(3**5, 3) == [1, 0, 0, 0, 0, 0]

    for _ in range(5):
        order = random.randint(2, 1_000_000_000)
        assert galois.field.poly_conversion.integer_to_poly(order**5 - 1, order) == [order - 1,]*5
        assert galois.field.poly_conversion.integer_to_poly(order**5, order) == [1, 0, 0, 0, 0, 0]
        assert galois.field.poly_conversion.integer_to_poly(order**5 + 1, order) == [1, 0, 0, 0, 0, 1]
...
def test_poly_to_integer():
    ...
    assert galois.field.poly_conversion.poly_to_integer([1, 0, 0, 0, 0, 0], 3) == 3**5

    for _ in range(5):
        order = random.randint(2, 1_000_000_000)
        assert galois.field.poly_conversion.poly_to_integer([order - 1,]*5, order) == order**5 - 1
        assert galois.field.poly_conversion.poly_to_integer([1, 0, 0, 0, 0, 0], order) == order**5
        assert galois.field.poly_conversion.poly_to_integer([1, 0, 0, 0, 0, 1], order) == order**5 + 1
