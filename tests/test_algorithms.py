...
def test_prime_factorization():
    assert galois.prime_factors(1) == []
    assert galois.prime_factors(8) == [(2, 3)]
    assert galois.prime_factors(10) == [(2, 1), (5, 1)]
    assert galois.prime_factors(11) == [(11, 1)]
    x, y = 46021, 65521
    assert galois.prime_factors(x * y) == [(x, 1), (y, 1)]


def test_euler_totient():
    # https://oeis.org/A000010
    N = list(range(1, 70))
    PHI = [1, 1, 2, 2, 4, 2, 6, 4, 6, 4, 10, 4, 12, 6, 8, 8, 16, 6, 18, 8, 12, 10, 22, 8, 20, 12, 18, 12, 28, 8, 30, 16,
           20, 16, 24, 12, 36, 18, 24, 16, 40, 12, 42, 20, 24, 22, 46, 16, 42, 20, 32, 24, 52, 18, 40, 24, 36, 28, 58,
...
def test_carmichael():
    ...
    N = list(range(1, 82))
    LAMBDA = [1, 1, 2, 2, 4, 2, 6, 2, 6, 4, 10, 2, 12, 6, 4, 4, 16, 6, 18, 4, 6, 10, 22, 2, 20, 12, 18, 6, 28, 4, 30, 8,
              10, 16, 12, 6, 36, 18, 12, 4, 40, 6, 42, 10, 12, 22, 46, 4, 42, 20, 16, 12, 52, 18, 20, 6, 18, 28, 58, 4,
              60, 30, 6, 16, 12, 10, 66, 16, 22, 12, 70, 6, 72, 36, 20, 18, 30, 12, 78, 4, 54]
